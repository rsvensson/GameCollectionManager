...
class SidePanel(QDockWidget):
    ...
    def showDetails(self, info):
        ...
        if info["Table"] == "games":
            ...
            self.platformsLabel.setVisible(True)
            self.fetchInfoButton.setEnabled(True)
            self.fetchInfoButton.setVisible(True)
            self.saveButton.setEnabled(True)
            self.saveButton.setVisible(True)
        elif info["Table"] == "consoles":
            self.genreLabel.setText("Country:")
            self.genreInfoLabel.setText(info["Country"])
            self.codeLabel.setText("Serial Number:")
            self.codeInfoLabel.setText(info["Serial number"])
            self.itemLabel.setText("Console:")
            self.itemInfoLabel.setText(info["Console"])
            self.platformsLabel.setVisible(False)
            self.platformsInfoLabel.setVisible(False)
            self.fetchInfoButton.setEnabled(False)
            self.fetchInfoButton.setVisible(False)
            ...
            self.itemInfoLabel.setText(info["Accessory"])
            self.platformsLabel.setVisible(False)
            self.platformsInfoLabel.setVisible(False)
            self.fetchInfoButton.setEnabled(False)
            self.fetchInfoButton.setVisible(False)
