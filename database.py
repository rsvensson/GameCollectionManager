...
class Database:
    ...
    def _refreshData(self):
        ...
        try:
            ...
            if "game" in self._file.name:
                fields = ["Platform,Name,Region,Code,Cart,Box,Manual,Comment"] if self._suff == ".csv"\
                    else ["Platform\tName\tRegion\tCode\tCart\tBox\tManual\tComment"]
    ...
    def saveData(self, newData):
        ...
        if len(newData) > 0:
            ...
            if "game" in self._file.name:
                fields = ["Platform", "Name", "Region", "Code", "Cart", "Box", "Manual", "Comment"]
            elif "console" in self._file.name:
